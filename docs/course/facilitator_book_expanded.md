---
title: "SpaceCDF — A Course Textbook in Concurrent Spacecraft Design"
subtitle: "Companion textbook for the SpaceCDF 40-hour Concurrent Design Facility programme"
...
footer-en: "SpaceCDF Course Textbook · 2026"
footer-fr: "Manuel de l'animateur SpaceCDF · 2026"
running: "SpaceCDF — Course Textbook"
toc: true
---
...
1. **Per-session course chapters** — one chapter per course session
   (Sessions 1.1 – 5.4). Each contains learning objectives,
   course chapters, exercises, expected reading, and supporting
   figures.
...
4. **Verification appendix** — a first-principles derivation and
   plot for every formula students uses, with cross-method
...
the worksheets students fills in.
...
The book began life as a *Course Textbook* filled with stage
directions ("Begin by asking the group…", "Students should draw the
...
curriculum. The first time a student in students generates an SRR
...
- **Refer to the Course Textbook** for session plans and appendices
...
# Part 3 — Position Quick-Reference Cards (quick-reference cards)
